...
> {
  ...
  componentWillReceiveProps(props) {
    if (
      props.totalPage != this.props.totalPage ||
  ...
  render() {
          ...
          return (
            <li key={number} className="active">
              <a
                ...
                data-key={number}
                id={"sr-pagination-" + this.state.id + "-" + number}
    ...
    if (this.state.isOnlyPrevNext == false) {
      if (pageNumbers.length > upperPageBound) {
        pageIncrementBtn = (
          <li className="">
            <a href="javascript:void(0)" onClick={this.btnIncrementClick}>
              {" "}
              &hellip;{" "}
            </a>
          </li>
    ...
    if (this.state.isOnlyPrevNext == false) {
      if (lowerPageBound >= 1) {
        pageDecrementBtn = (
          <li className="">
            <a href="javascript:void(0)" onClick={this.btnDecrementClick}>
              {" "}
              &hellip;{" "}
            </a>
          </li>
    ...
    if (isPrevBtnActive === "disabled") {
      ...
      renderPrevBtn = (
        <li className={isPrevBtnActive}>
          <a href="javascript:void(0)" id="btnPrev" onClick={this.btnPrevClick}>
            {prevTextElement}
          </a>
        </li>
      );
    ...
    if (isNextBtnActive === "disabled") {
      renderNextBtn = (
        <li className={isNextBtnActive}>
          <span id="btnNext"> {nextTextElement} </span>
        </li>
      );
    } else {
      renderNextBtn = (
        <li className={isNextBtnActive}>
          <a href="javascript:void(0)" id="btnNext" onClick={this.btnNextClick}>
            {" "}
            {nextTextElement}{" "}
          </a>
        </li>
